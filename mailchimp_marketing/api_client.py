...
class ApiClient(object):
    ...
    def set_config(self, config={}):
        ...
        self.proxy = config["proxy"] if "proxy" in config.keys() else None
        self.verify = config["verify"] if "verify" in config.keys() else True
    ...
    def call_api(
        ...
        **kwargs,
        ...
        try:
            res = self.request(
                method, url, query_params, headers=header_params, body=body
            )
